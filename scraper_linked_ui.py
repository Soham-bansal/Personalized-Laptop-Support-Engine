...
def scrape_laptop_details_parallel(laptop_links):
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=5) as executor:
        future_to_link = {executor.submit(scrape_laptop_detail, link): link for link in laptop_links}
...
if __name__ == "__main__":
    ...
    scraped_details = scrape_laptop_details_parallel(sample_links)
