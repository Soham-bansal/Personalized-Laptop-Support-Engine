...
# Center the heading
st.markdown(
    "<h1 style='text-align: center; color: white; font-size: 36px;'>AI-Powered Laptop Recommendation System</h1>",
    unsafe_allow_html=True
)
st.markdown(
    "<h3 style='text-align: center; color: grey;'>Get personalized laptop recommendations based on your preferences!</h3>",
    unsafe_allow_html=True
)
...
if show_results and not top_recommendations.empty:
    ...
    if show_results:
        ...
        st.markdown(
            ...
            "<h3>Welcome to the AI-Powered Laptop Recommendation System!</h3>"
